// js/data.js - Productos del catálogo con Nicho Espiritual
const productos = [
  ...
  // ==================== EDICIÓN ESPECIAL - ESPIRITUAL (USD) ====================
  {
    ...
    tamano: "Ajustable",
    descripcion: "Amuleto de protección y conexión con la energía lunar, para atraer la intuición y la calma.",
    significado: {
  ...
  },
  {
    ...
    descripcion: "Inspirado en la cosmovisión andina, este atrapasueños protege y atrae la sabiduría de los ancestros.",
    significado: {
  ...
  },
  {
    ...
    tamano: "Alto 20 cm",
    descripcion: "Figura que representa el equilibrio cósmico entre el sol y la luna, ideal para espacios de meditación.",
    significado: {
  ...
  },
  {
    ...
    tamano: "Ajustable",
    descripcion: "Pulsera con las 7 piedras de los chakras principales, para equilibrar y armonizar la energía vital.",
    significado: {
  ...
  },
  {
    ...
    descripcion: "Atrapasueños inspirado en las constelaciones, para conectar con la sabiduría de los astros.",
    significado: {
...
// Si estás usando Node.js o necesitas exportar el módulo
